...
@CompileStatic
enum DropshipClasspath implements MavenIdContains, ToFileRef2 {
...
//    groovy('org.codehaus.groovy:groovy:3.0.7')
    ...
    , javaAssist('org.javassist:javassist:3.27.0-GA')
    // 'org.javassist:javassist:3.22.0-GA' - support java 7
...
//    , ivyMavenId("org.apache.ivy:ivy:2.4.0")
    , ivyMavenId('org.apache.ivy:ivy:2.5.0')

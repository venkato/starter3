...
//    }
    ...
    /**
     * need replace by
     * @see net.sf.jremoterun.utilities.init.v2.JrrV2Settings#downloadDepOninit
     */
    public static boolean downloadDepOninit = false
    ...
    static void downloadyIvydepToIvyDir() {
        ...
        allLibsWithGroovyAndXmlApi.each {
            mavenDependenciesResolver.resolveAndDownloadDeepDependencies(it.m, false, downloadDepOninit)

...
@CompileStatic
class IvyDepResolver2 implements MavenDependenciesResolver , IvyListenerManager {
...
//            Thread.dumpStack()
    ...
    void addIvyListener(IvyListener ideaIvyEvent) {
        ivy.eventManager.addIvyListener(ideaIvyEvent)
    }

    @Override
    void removeIvyListener(IvyListener ideaIvyEvent) {
        ivy.eventManager.removeIvyListener(ideaIvyEvent)
    }
}

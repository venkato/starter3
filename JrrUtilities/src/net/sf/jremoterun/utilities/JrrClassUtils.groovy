...
import net.sf.jremoterun.utilities.reflection.Java21Refelction
        ...
        if (modifiersField == null) {
            ...
            try {
                try {
                    ...
                    getFieldAccessorMethod21  = findMethodByParamTypes3(Field, "getFieldAccessor"); //NOFIELDCHECK
                    getFieldAccessorMethod21.setAccessible(true)
                    getOverrideFieldAccessor21  = findMethodByParamTypes3(Field, "getOverrideFieldAccessor"); //NOFIELDCHECK
                ...
                try {
                    memberNameConstructor = findConstructorByCount(new ClRef("java.lang.invoke.MemberName"), 2);
                    memberNameConstructor.setAccessible(true);
                    getReferenceKindMethod = findMethodByCount(new ClRef("java.lang.invoke.MemberName"), "getReferenceKind", 0)
//                    lookupField = findField(java.lang.invoke.MethodHandles.Lookup, "IMPL_LOOKUP")
                    getDirectFieldNoSecurityManagerMethod = findMethodByCount(new ClRef(java.lang.invoke.MethodHandles.Lookup), "getDirectFieldNoSecurityManager", 3)

                    lookupJava21 = (MethodHandles.Lookup) JrrClassUtils.getFieldValue(java.lang.invoke.MethodHandles.Lookup, "IMPL_LOOKUP");
    ...
    public static Field[] findReadOnlyAndFinalFields(Class class1) throws NoSuchFieldException {
        ...
        if (fields == null) {
            ...
            try {
                isReadOnlyField = JrrClassUtils.findField(class1, "isReadOnly"); //NOFIELDCHECK
                isReadOnlyField.setAccessible(true);
            } catch (NoSuchFieldException e) {
                log.fine("Can't find isReadOnly field in class ${class1.getName()}");
            }
            try {
                isFinalField = JrrClassUtils.findField(class1, "isFinal"); //NOFIELDCHECK
    ...
    public static void setFinalFieldValue(Object onInvoke, Field field, Object fieldValue)
        ...
        findModifiersField();
        if(getDirectFieldNoSecurityManagerMethod!=null){
            try {

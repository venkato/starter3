...
@CompileStatic
class RunnableClRefWithAdderAsParam implements Runnable, RunnerCreationCallStack, CallerInfo, CallerInfoGetter  {
    ...
    RunnableClRefWithAdderAsParam(ClRefRef clRef) {
        this.clRef = clRef
        assert clRef!=null
    }
    ...
    void run() {
        ...
        LoadScriptFromFileUtils.runWithParams(obj, GroovyMethodRunnerParams.gmrpn.addFilesToClassLoader, null)
    }

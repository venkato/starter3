        ...
        if (JrrClassUtilsFindMethodFields.modifiersField == null) {
            ...
            try {
                try {
                    ...
                    JrrClassUtilsFindMethodFields.getFieldAccessorMethod21 = findMethodByParamTypes3(Field, "getFieldAccessor");
                    //NOFIELDCHECK
                    JrrClassUtilsFindMethodFields.getFieldAccessorMethod21.setAccessible(true)
                    JrrClassUtilsFindMethodFields.getOverrideFieldAccessor21 = findMethodByParamTypes3(Field, "getOverrideFieldAccessor");
                    //NOFIELDCHECK
                ...
                try {
                    ...
                    try {
                        ...
                        log.log(Level.INFO, "can't find field java21, try now java25 ", e4);
                        // java25
                        JrrClassUtilsFindMethodFields.getDirectFieldNoSecurityManagerMethod = findMethodByCount(new ClRef(java.lang.invoke.MethodHandles.Lookup), "getDirectField", 3)
                    }
...
//        jdk.internal.reflect.UnsafeFieldAccessorImpl
    ...
    public void setFieldValue(Object onObjectOrClass, final String fieldName, Object fieldValue)
        ...
        setFieldValue2(field, onInvoke, fieldValue)
    }

    public void setFieldValue2(Field field, Object onInvoke, Object fieldValue) {
